namespace NoteTaking
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// txtTitle
			// 
			txtTitle.Location = new Point(121, 58);
			...
			// txtMessage
			// 
			txtMessage.Location = new Point(121, 107);
			...
			dataGridView1.Size = new Size(260, 270);
			dataGridView1.TabIndex = 4;
			// 
			// btnNew
			// 
			btnNew.Location = new Point(121, 380);
			btnNew.Name = "btnNew";
			...
			// btnSave
			// 
			btnSave.Location = new Point(270, 380);
			...
			// btnRead
			// 
			btnRead.Location = new Point(421, 380);
			...
			// btnDelete
			// 
			btnDelete.Location = new Point(573, 380);
